...
- [ ] T012 [P] [US1] Contract test for [endpoint or CLI behavior] in tests/contract/test_[name].py
- [ ] T013 [P] [US1] Integration test for [user journey or PR-session flow] in tests/integration/test_[name].py
- [ ] T014 [P] [US1] Regression test for changed final-gate, session, parser, or packaged-skill contract in tests/[name].py
...
- [ ] T019 [US1] Add fail-fast validation and error handling
- [ ] T020 [US1] Add audit, trace, or machine-summary evidence for user story 1 operations
...
- [ ] T021 [P] [US2] Contract test for [endpoint or CLI behavior] in tests/contract/test_[name].py
- [ ] T022 [P] [US2] Integration test for [user journey or PR-session flow] in tests/integration/test_[name].py
...
- [ ] T027 [P] [US3] Contract test for [endpoint or CLI behavior] in tests/contract/test_[name].py
- [ ] T028 [P] [US3] Integration test for [user journey or PR-session flow] in tests/integration/test_[name].py
...
- [ ] TXXX Verify repo-root vs skill-root path language in updated docs
...
- All independent tests for a user story marked [P] can run in parallel
...
Task: "Contract test for [endpoint or CLI behavior] in tests/contract/test_[name].py"
Task: "Integration test for [user journey or PR-session flow] in tests/integration/test_[name].py"
...
- Public CLI, session, final-gate, and packaged-skill contract changes require tests
